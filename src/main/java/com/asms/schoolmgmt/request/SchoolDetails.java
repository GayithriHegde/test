...
public class SchoolDetails {
	...
	public void setBoardDetails(String boardDetails) {
	...
	public String getTrustRegistrationNumber() {
		return trustRegistrationNumber;
	}

	public void setTrustRegistrationNumber(String trustRegistrationNumber) {
		this.trustRegistrationNumber = trustRegistrationNumber;
	}
